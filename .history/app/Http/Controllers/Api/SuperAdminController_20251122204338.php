...
class SuperAdminController extends Controller
{
    ...
    /**
     * حذف فعالية (مع كل المقترحات والتقييمات)
     */
    public function deleteEvent($id)
    {
        ...
        $event->delete(); // Cascade delete submissions and evaluations
